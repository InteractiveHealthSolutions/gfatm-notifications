...
/**
 * @author Shujaat This job execute Bi-week
 */
public class PatientScheduledEmailNotificationJobLegacy {
	...
	public void execute() {
		...
		openMrsUtil.getPatientScheduledForVisit(startVisitDateStr,
				endVisitDateStr);
		scheduledPatient();

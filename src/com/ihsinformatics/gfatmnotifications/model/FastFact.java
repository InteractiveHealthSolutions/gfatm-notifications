...
public class FastFact {
	...
	/**
	 * @return the totalScreeingForm
	 */
	public Integer getTotalScreeingForm() {
	...
	/**
	 * @return the chestXrays
	 */
	public Integer getChestXrays() {
		return chestXrays;
	}
	...
	/**
	 * @return the verbalScreenPresumptives
	 */
	public Integer getVerbalScreenPresumptives() {
		return verbalScreenPresumptives;
	}
	...
	/**
	 * @return the chestXrayPresumptives
	 */
	public Integer getChestXrayPresumptives() {
		return chestXrayPresumptives;
	}
	...
	/**
	 * @return the samplesCollectedVerbalScreenPresumptives
	 */
	...
	/**
	 * @return the samplesCollectedCXRPresumptives
	 */
	...
	/**
	 * @return the mTBpveExternal
	 */
	public Integer getmTBpveExternal() {
		return mTBpveExternal;
	}
	...
	/**
	 * @return the mTBpveRRpveInternal
	 */
	...
	/**
	 * @return the mTBpveRRpveExternal
	 */
	public Integer getmTBpveRRpveExternal() {
		return mTBpveRRpveExternal;
	}
	...
	/**
	 * @return the invalidAllTest
	 */
	public Integer getInvalidAllTest() {
		return invalidAllTest;
	}
	...
	/**
	 * @return the clinicallyDiagnosed
	 */
	...
	/**
	 * @return the initiatedOnAntibiotic
	 */
	...
	/**
	 * @return the secondaryContct
	 */
	public String getSecondaryContct() {
		return secondaryContct;
	}

...
public class ChilhoodFact {
	...
	/**
	 * @return the screenedByNurse
	 */
	public Integer getScreenedByNurse() {
		return screenedByNurse;
	}
	/**
	...
	/**
	 * @return the presumptiveByNurse
	 */
	public Integer getPresumptiveByNurse() {
		return presumptiveByNurse;
	}
	/**
	...
	/**
	 * @return the screeningLocationForms
	 */
	public Integer getScreeningLocationForms() {
		return screeningLocationForms;
	}
	/**
	...
	/**
	 * @return the registrationForms
	 */
	public Integer getRegistrationForms() {
	...
	/**
	 * @return the presumptiveCaseConfirmedForms
	 */
	public Integer getPresumptiveCaseConfirmedForms() {
		return presumptiveCaseConfirmedForms;
	}
	/**
	...
	/**
	 * @return the tbPresumptiveConfirmed
	 */
	public Integer getTbPresumptiveConfirmed() {
		return tbPresumptiveConfirmed;
	}
	/**
	...
	/**
	 * @return the testIndication
	 */
	public Integer getTestIndication() {
	...
	/**
	 * @return the cbcIndicated
	 */
	public Integer getCbcIndicated() {
		return cbcIndicated;
	}
	/**
	...
	/**
	 * @return the esrIndicated
	 */
	public Integer getEsrIndicated() {
		return esrIndicated;
	}
	/**
	...
	/**
	 * @return the cxrIndicated
	 */
	public Integer getCxrIndicated() {
		return cxrIndicated;
	}
	/**
	...
	/**
	 * @return the mtIndicated
	 */
	public Integer getMtIndicated() {
		return mtIndicated;
	}
	/**
	...
	/**
	 * @return the ultrasoundIndicated
	 */
	public Integer getUltrasoundIndicated() {
		return ultrasoundIndicated;
	}
	/**
	...
	/**
	 * @return the histopathologyFNACIndicated
	 */
	public Integer getHistopathologyFNACIndicated() {
		return histopathologyFNACIndicated;
	}
	/**
	...
	/**
	 * @return the ctScanIndicated
	 */
	public Integer getCtScanIndicated() {
		return ctScanIndicated;
	}
	/**
	...
	/**
	 * @return the gxpIndicated
	 */
	public Integer getGxpIndicated() {
		return gxpIndicated;
	}
	/**
	...
	/**
	 * @return the tbTreatmentIntiated
	 */
	public Integer getTbTreatmentIntiated() {
		return tbTreatmentIntiated;
	}
	/**
	...
	/**
	 * @return the antibioticTrialInitiated
	 */
	public Integer getAntibioticTrialInitiated() {
		return antibioticTrialInitiated;
	}
	/**
	...
	/**
	 * @return the iptTreatmentInitiated
	 */
	public Integer getIptTreatmentInitiated() {
		return iptTreatmentInitiated;
	}
	/**
	...
	/**
	 * @return the tbTreatmentFUP
	 */
	public Integer getTbTreatmentFUP() {
		return tbTreatmentFUP;
	}
	/**
	...
	/**
	 * @return the antibioticTrialFUP
	 */
	public Integer getAntibioticTrialFUP() {
		return antibioticTrialFUP;
	}
	/**

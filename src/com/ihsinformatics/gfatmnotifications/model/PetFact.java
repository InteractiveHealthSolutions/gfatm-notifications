...
public class PetFact {
	...
	/**
	 * @return the noOfIndexPatientRegistered
	 */
	public Integer getNoOfIndexPatientRegistered() {
		return noOfIndexPatientRegistered;
	}
	/**
	...
	/**
	 * @return the noOfDSTBPatients
	 */
	public Integer getNoOfDSTBPatients() {
		return noOfDSTBPatients;
	}
	/**
	...
	/**
	 * @return the noOfDRTBPatients
	 */
	public Integer getNoOfDRTBPatients() {
		return noOfDRTBPatients;
	}
	/**
	...
	/**
	 * @return the noOfBaselineScreening
	 */
	public Integer getNoOfBaselineScreening() {
		return noOfBaselineScreening;
	}
	/**
	...
	/**
	 * @return the noOfIndexPatientsAgreed
	 */
	public Integer getNoOfIndexPatientsAgreed() {
		return noOfIndexPatientsAgreed;
	}
	/**
	...
	/**
	 * @return the noOfAdultsContacts
	 */
	public Integer getNoOfAdultsContacts() {
		return noOfAdultsContacts;
	}
	/**
	...
	/**
	 * @return the noOfPeadsContacts
	 */
	public Integer getNoOfPeadsContacts() {
		return noOfPeadsContacts;
	}
	/**
	...
	/**
	 * @return the noOfIndexNotEligibleStudy
	 */
	public Integer getNoOfIndexNotEligibleStudy() {
		return noOfIndexNotEligibleStudy;
	}
	/**
	...
	/**
	 * @return the noOfContactScreeningCounselingDone
	 */
	public Integer getNoOfContactScreeningCounselingDone() {
		return noOfContactScreeningCounselingDone;
	}
	/**
	 * @param noOfContactScreeningCounselingDone the noOfContactScreeningCounselingDone to set
	 */
	...
	/**
	 * @return the noOfBaselineCounselingDone
	 */
	public Integer getNoOfBaselineCounselingDone() {
		return noOfBaselineCounselingDone;
	}
	/**
	...
	/**
	 * @return the noOfContactsInvestigated
	 */
	public Integer getNoOfContactsInvestigated() {
		return noOfContactsInvestigated;
	}
	/**
	...
	/**
	 * @return the noOfContactsDiagnosedTB
	 */
	public Integer getNoOfContactsDiagnosedTB() {
		return noOfContactsDiagnosedTB;
	}
	/**
	...
	/**
	 * @return the noOfContactsEligiblePET
	 */
	public Integer getNoOfContactsEligiblePET() {
		return noOfContactsEligiblePET;
	}
	/**
	...
	/**
	 * @return the noOfContactsAgreedPET
	 */
	public Integer getNoOfContactsAgreedPET() {
		return noOfContactsAgreedPET;
	}
	/**
	...
	/**
	 * @return the noOfContactsCompletedTreatment
	 */
	public Integer getNoOfContactsCompletedTreatment() {
		return noOfContactsCompletedTreatment;
	}
	/**
	 * @param noOfContactsCompletedTreatment the noOfContactsCompletedTreatment to set
	 */
